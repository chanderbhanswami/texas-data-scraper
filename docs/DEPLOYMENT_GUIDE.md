...
# v1.5.0 Google Places API settings
GOOGLE_PLACES_API_KEY=your_api_key_here
GOOGLE_PLACES_BILLING=false
GOOGLE_PLACES_RATE_LIMIT_STANDARD=600
GOOGLE_PLACES_RATE_LIMIT_BILLING=6000
GOOGLE_PLACES_CONCURRENT_REQUESTS=5
GOOGLE_PLACES_CHUNK_SIZE=50
```
